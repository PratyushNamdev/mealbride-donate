...
export default function IntroSection({
  ...
  return (
    <div className="md:min-h-screen flex flex-wrap flex-col gap-5 items-center pt-20 px-auto bg-gradient-to-r from-[#f0f9f4] via-white to-[#f0f9f4]">
      <h1 className="text-center text-4xl font-bold bg-gradient-to-r from-[#278049] to-green-500 bg-clip-text text-transparent pb-1">
        MealBridge
      </h1>
      ...
      <div className="mt-10 flex flex-wrap justify-center items-center sm:gap-4 ">
        {impact.map((val, indx) => (
          <div
